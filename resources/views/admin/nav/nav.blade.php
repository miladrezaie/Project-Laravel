...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html">پنل مدیریت SB نسخه 2.0</a>
    </div>
    <!-- /.navbar-header -->
    ...
    <ul class="nav navbar-top-links navbar-left">
            ...
            <ul class="dropdown-menu dropdown-messages">
                <li>
                    <a href="#">
                        ...
                        <div>لورم یک متن طولانی که مفهوم خاصی ندارد و فقط طولانی است ...</div>
                    </a>
                </li>
                <li class="divider"></li>
                <li>
                ...
                <li>
                    <a class="text-center" href="#">
                        <strong>خواندن همه پیام ها</strong>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-tasks">
                <li>
                    <a href="#">
                        <div>
                            <p>
                                <strong>کار 1</strong>
                                <span class="pull-left text-muted">40% پیشرفت</span>
                            </p>
                ...
                <li>
                    <a href="#">
                        <div>
                            <p>
                                <strong>کار 2</strong>
                                <span class="pull-left text-muted">20% پیشرفت</span>
                            </p>
                            <div class="progress progress-striped active">
                ...
                <li>
                    <a href="#">
                        <div>
                            <p>
                                <strong>کار 4</strong>
                                <span class="pull-left text-muted">80% پیشرفت</span>
                            </p>
                            <div class="progress progress-striped active">
                ...
                <li>
                    <a class="text-center" href="#">
                        <strong>مشاهده همه کارها</strong>
                        <i class="fa fa-angle-left"></i>
                    </a>
                </li>
            </ul>
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="tables.html"><i class="fa fa-table fa-fw"></i> جدول ها</a>
                </li>
                <li>
                    <a href="forms.html"><i class="fa fa-edit fa-fw"></i> فرم ها</a>
                </li>
                <li>
                    <a href="#"><i class="fa fa-wrench fa-fw"></i> اجزای طراحی<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="notifications.html">اعلانات</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="#"><i class="fa fa-sitemap fa-fw"></i> چند سطحی<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">سطح دوم</a>
                        </li>
